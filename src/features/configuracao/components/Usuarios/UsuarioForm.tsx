...
/**
 * Interface de props para o formulário de usuário.
 * Define que o componente deve receber uma função onSave.
 */
...
/**
 * UsuarioForm: Componente de formulário para criar ou editar um usuário.
 * Recebe dados e callbacks via props para manter-se desacoplado da lógica de negócio.
 */
export const UsuarioForm = ({ onSave }: UsuarioFormProps) => {
